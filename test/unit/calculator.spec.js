...
//this code adds 2 failing unit tests to check that the add function int he calc
//object exists, not only behaves as expected, but also exists in the first place.
